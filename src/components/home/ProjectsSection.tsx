...
const featuredProjects = [
  {
    id: 1,
    name: 'Project Alpha',
    description: 'A cutting-edge machine learning framework for predictive analytics and data processing.',
    stars: 256,
    forks: 58,
    language: 'Python',
  ...
  },
  {
    id: 2,
    name: 'CloudSync',
    description: 'Enterprise-grade cloud infrastructure synchronization and management solution.',
    stars: 198,
    forks: 42,
    language: 'TypeScript',
  ...
  {
    id: 3,
    name: 'DataViz Framework',
    description: 'Interactive data visualization toolkit for building beautiful and responsive dashboards.',
    stars: 324,
    forks: 89,
    language: 'JavaScript',
